...
#появляется окно с полем "Введите имя заметки"
...
def show_note():
    #получаем текст из заметки с выделенным названием и отображаем его
...
def save_note():
    if list_notes.selectedItems():
        ...
        print('Заметка для сохранения не сработала!')
#удаление заметки
def del_note():
    if list_notes.selectedItems():
        key = list_notes.selectedItems()[0].text()
        ...
        print('Заметка для удаления не сработала!')
...
def add_tag():
    if list_notes.selectedItems():
        ...
        print('Заметка для добавлнения тега не выбрана!')
#тег удаления
def del_tag():
